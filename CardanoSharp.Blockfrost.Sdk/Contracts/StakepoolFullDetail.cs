...
public class StakepoolFullDetail
{
	...
	/// VRF key hash
	/// </summary>
	[JsonPropertyName("vrf_key")] public string VrfKey { get; set; } = default!;
	...
	/// </summary>
	[JsonPropertyName("declared_pledge")] public string DeclaredPledge { get; set; } = default!;

	/// <summary>
	/// Stake pool current pledge
	/// </summary>
	[JsonPropertyName("live_pledge")] public string LivePledge { get; set; } = default!;
	...
	/// </summary>
	[JsonPropertyName("fixed_cost")] public string FixedCost { get; set; } = default!;

	/// <summary>
	/// Bech32 reward account of the stake pool
	/// </summary>
	[JsonPropertyName("reward_account")] public string RewardAccount { get; set; } = default!;

	/// <summary>
	/// Array of strings
	/// </summary>
	[JsonPropertyName("owners")] public string[] Owners { get; set; } = default!;

	/// <summary>
	/// Array of strings
	/// </summary>
	[JsonPropertyName("registration")] public string[] Registration { get; set; } = default!;

	/// <summary>
	/// Array of strings
	/// </summary>
	[JsonPropertyName("retirement")] public string[] Retirement { get; set; } = default!;
}
